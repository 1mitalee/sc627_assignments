...
def DotProductArrays(v1, v2):
    ...
    #m= m/(math.sqrt(v1[0]**2 + v1[1]**2)*math.sqrt(v2[0]**2 + v2[1]**2)
    return m


# P= np.array([[1, 2], [1, 0], [3, 0]])
# q= np.array([1.01, 1.98])
# u= computeTangentVectorToPolygon(P, q)
# print(u)

# p1=[1,2]
# p2=[3,0]
# D=computeDistancePointToSegment(q, p1, p2)
# print(D)
